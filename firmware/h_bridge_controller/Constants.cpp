...
const bool pattern_enabled_default[BRIDGE_COUNT] = {true,true,true,true};
...
CONSTANT_STRING(pattern_positive_count_field_name,"pattern_positive_count");
const long pattern_count_min = 0;
const long pattern_count_max = 1000;
const long pattern_positive_count_default = 1;
